...
namespace OriginalL2MagicDmgCalculator.Stats
{
    public class BuffStats : SkillStats
    {
        ...
        protected readonly ushort BuffMAtkBoost2;
        ...
        public BuffStats(string buffFullName1, string buffFullName2, string buffFullName3, string buffFullName4, string buffFullName5, string buffFullName6, ushort buffMAtkBoost1, ushort buffMAtkBoost2, ushort buffMAtkBoost3, ushort buffMAtkBoost4, ushort buffMAtkBoost5, ushort buffMAtkBoost6, uint heroicBerserkerMAtkBoost,
        ...
        public BuffStats(string buffFullName1, string buffFullName2, string buffFullName3, string buffFullName4, string buffFullName5, string buffFullName6, ushort buffMAtkBoost1, ushort buffMAtkBoost2, ushort buffMAtkBoost3, ushort buffMAtkBoost4, ushort buffMAtkBoost5, ushort buffMAtkBoost6, uint heroicBerserkerMAtkBoost,
            SkillStats skillStats) : base (skillStats)
        {
